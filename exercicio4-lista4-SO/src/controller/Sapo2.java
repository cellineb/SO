...
public class Sapo2 extends Thread{
	...
	public void run() {
		...
		while (distanciaPercorrida < distanciaMaxima) {
			...
			System.out.println("O sapo 2 deu um pulo de " + pulo + " metros. Ele já percorreu " + distanciaPercorrida + " metros.");
		}
		if (distanciaPercorrida >= distanciaMaxima) {
			System.out.println("O sapo 2 chegou!");
			System.out.println("O sapo 2 chegou na " + Classificacao.Colocacao() + "° colocação!");
		}
